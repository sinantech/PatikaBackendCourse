public class Main {
    public static void main(String[] args) {
        ...
        // Liste veri türünde alt bir liste olusturdu
        MyList<Integer> altListem = liste.subList(0, 3);
        System.out.println(altListem.toString());

        // Degerim listedeki olup olmadıgını sorguladı
        System.out.println("Listemde 20 deðeri : " + liste.contains(20));
        System.out.println("Listemde 120 deðeri : " + liste.contains(120));

        // Listeyi tamamen bosaltır ve varsayılan boyutuna çevirir
        liste.clear();
